...
public partial class TranslucentImage : Image, IMeshModifier
{
    ...
    bool Validate()
    {
        ...
        if (!source)
        {
            ...
            {
                Debug.LogError("TranslucentImageSource is missing. Add TranslucentImageSource component to your main camera, then assign it camera to the Source field of the Translucent Image(s)");
            }
