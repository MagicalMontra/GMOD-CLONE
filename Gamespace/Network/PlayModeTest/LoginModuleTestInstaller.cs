...
{
    [CreateAssetMenu(menuName = "Installer/TDD/Network Tests/Create LoginModuleTestInstaller", fileName = "LoginModuleTestInstaller", order = 0)]
    public class LoginModuleTestInstaller : ScriptableObjectInstaller<LoginModuleTestInstaller>
    {
