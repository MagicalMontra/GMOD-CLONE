...
namespace Gamespace.Localization
{
    ...
    {
        private readonly string START_OPEN_TAG = "<";
        private readonly string START_CLOSED_TAG = "</";
        private readonly string END_TAG = ">";

        public TagString[] Parser(string str)
        {
        ...
        private string Concat(params char[] values)
        {
            string ret = "";
        ...
        private bool StartWithCloseTag(string str, int i) {
            return i + 1 < str.Length && Concat(str[i], str[i + 1]) == START_CLOSED_TAG;
        }

        private bool StartWithOpenTag(string str, int i)
        {
